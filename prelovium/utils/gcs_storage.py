...
class GCSStorage:
    ...
    def __init__(self):
        ...
        self.bucket_name = os.getenv('GCS_BUCKET_NAME', 'prelovium-images')
    ...
    def upload_images_for_upload(self, upload_id: str, original_files: Dict, processed_images: Dict) -> Tuple[Dict, Dict]:
        """
